...
<body class="body-wrapper ">
	<div class="main-wrapper">
		...
		<jsp:include page="/WEB-INF/views/food/pagetitle/food-pagetitle.jsp">
			<jsp:param name="requestPage" value="food-update"/>
		</jsp:include>
				...
				<div class="row">
					<div class="col-sm-6 col-md-5 col-lg-4 col-xs-12">
						...
						<div class="contactInfo">
							<h2>맛집 정보 수정</h2>
							<p>등록한 지역 맛집 정보를 수정합니다. 수정할 정보를 입력해주세요.</p>
							<div class="media">
					...
					<div class="col-sm-6 col-md-7 col-xs-12 col-lg-8">
						<div class="contactForm">
							<form action="/janditour/food_update.action" method="post" role="form"
								class="form" enctype="multipart/form-data">
								<div class="">
				              	  <select class="select" name="citName" data-select="${food.citName}">
				              	  	...
				              	  	<input type="text" class="addr" name="foodAddress" placeholder="상세 주소" value="${food.foodAddress}">
				              	 </div>
								<div class="form-group">
									<input type="text" class="form-control" id="" name="foodName"
										placeholder="맛집 이름" value="${food.foodName}">
								</div>
								...
								<div class="form-group">
									<input type="text" class="form-control" id=""
										name="foodListContent" placeholder="간략 소개글" value="${food.foodListContent}">
								</div>
								<div class="form-group">
									<textarea class="form-control" id="" placeholder="소개글"
										name="foodContent">${food.foodContent}</textarea>
								</div>
								<input type="hidden" name="foodNo" value="${food.foodNo}">
								<input type="hidden" name="foodCheck" value="${food.foodCheck}">
								
								<a id="cancel" class="btn buttonCustomPrimary">취소</a>
								
								<button id="update-action" type="submit" class="btn buttonCustomPrimary">수정</button>
