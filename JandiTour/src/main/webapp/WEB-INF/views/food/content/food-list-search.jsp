...
<c:if test="${param.requestPage eq 'food-list-search'}">
	<div id ="food-search" class="col-sm-3 col-xs-12">
		<aside>
				...
				<div class="panel panel-default packagesFilter">
					...
					<div class="panel-body">
						<div class="row">
							...
							<div class="col-sm-12">
								<a id="searchBtn" href="#" class="btn btn-block buttonTransparent">검색</a>
							</div>
						</div>
					</div>
				</div>
