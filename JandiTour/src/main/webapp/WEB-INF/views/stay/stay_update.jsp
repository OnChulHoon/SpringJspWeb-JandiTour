        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-md-7 col-xs-12 col-lg-8">
            <div class="contactForm">
              ...
              <form action="stay_update.action" method="post" role="form" class="form" enctype="multipart/form-data">
              	<input type="hidden" name="staNo" value="${ stay.staNo }" /> 	
                <div class="">
              	  <select class="select" name="citName" data-select="${stay.citName}">
              	  	...
              	  	<input type="text" class="addr" name="staAddress" value="${ stay.staAddress }">
              	  </select>
              	</div>
                <div class="form-group">
                  <input type="text" class="form-control"  name="staName" value="${ stay.staName }">
                </div>  
                <div class="form-group">
                  <input type="text" class="form-control"  name="staListCon" value="${ stay.staListCon }">
                </div>       
                ...
                <div class="form-group">
                  <textarea class="form-control" name="staContent">${ stay.staContent }</textarea>
                </div>
                 <input type="hidden" name= "staCheck" value="${ stay.staCheck }">
