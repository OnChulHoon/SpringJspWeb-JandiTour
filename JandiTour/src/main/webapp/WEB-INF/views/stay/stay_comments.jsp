...
<div id="scrollbar" style="overflow: auto; width: 1000px; height: 440px;">
<ul class="media-list">
			...
			<div id="reviewView${ review.reNo }" class="media-body">
					...
					<div>${ review.reContent }
						<span id="re_btn" class="btn-wrap"
							...
							<input id="modal_reNo${ review.reNo }" type="hidden" value="${ review.reNo }">
							<input id="modal_pageno" type="hidden" value="${ pageno }"> <input
							id="modal_stano" type="hidden" value="${ stay.staNo }">
							<input id="modal_content${ review.reNo }" type="hidden" 
							value="${ review.reContent }"> 
							<%-- <a id="edit" href="javascript:" class="button"
