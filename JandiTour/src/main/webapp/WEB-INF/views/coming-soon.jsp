...
<head>
  ...
  <title>Coming Soon - Star Travel</title>
  ...
  <link rel="stylesheet" type="text/css" href="resources/plugins/rs-plugin/revolution/css/settings.css">
  <link rel="stylesheet" type="text/css" href="resources/plugins/rs-plugin/revolution/css/layers.css">
  <link rel="stylesheet" type="text/css" href="resources/plugins/rs-plugin/revolution/css/navigation.css">
...
<body class="comingSoonBg">
  <div class="comingTitle">
    <img src="resources/img/logo-icon.png" alt="image">
  </div>
  ...
  <script src="resources/plugins/rs-plugin/revolution/js/jquery.themepunch.tools.min.js"></script>
  <script src="resources/plugins/rs-plugin/revolution/js/jquery.themepunch.revolution.min.js"></script>
  <script src="resources/plugins/selectbox/jquery.selectbox-0.1.3.min.js"></script>
  <script src="resources/plugins/datepicker/bootstrap-datepicker.js"></script>
  <script src="resources/plugins/jquery/waypoints.min.js"></script>
