		...
		$('#search')
				.on(
						...
						function(event) {
							var area = $('#area').val();
							var area2 = $('#area2').val();
							var touName = $('#touName').val();

							if (area == '' && area2 == '' && touName == '') {
								alert('검색할 지역이나 여행지를 선택/입력하세요.');
								return;
							}

							location.href = '/janditour/tourist/tourist_list.action?area='
									+ encodeURI(area)
									+ '&area2='
									+ encodeURI(area2)
									+ '&touName='
							...
							<div class="titleTableInner">
								<div class="pageTitleInfo">
									...
									<c:if test="${not empty loginuser and loginuser.memDiv eq '1'}">
										<div align="center">
											<a href="/janditour/tourist/tourist_write.action"
												class="btn buttonTransparent">여행지 정보 등록</a>
										</div>
									</c:if>
								</div>
							</div>
			...
			<div class="container">
				<div class="row">
					<div id="banner" class="col-sm-3 col-xs-12">
						<aside>
							<form action="/janditour/tourist/tourist_list.action"
								method="post">
								<div class="panel panel-default packagesFilter">
									<div class="panel-heading">
										<h3 class="panel-title">여행지 검색</h3>
									</div>
									<div class="panel-body">
										<div class="row">
											...
											<div class="col-xs-12">
												<div class="" data-provide="">
													<input type="text" class="form-control"
														placeholder="여행지 검색" id="touName" name="touName">
													<br>
												</div>
											</div>
											...
											<div class="col-sm-12">
												<a id="search" href="#"
													class="btn btn-block buttonTransparent">검색</a>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="thumbnail deals packagesPage">
										...
										<div class="caption">
											...
											<div class="detailsInfo">
												<h5>
													<span>평점</span><i class="fa fa-star" aria-hidden="true"></i> ${ tourist.touRating }.0
												</h5>
