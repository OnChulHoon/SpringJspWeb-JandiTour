				...
				<div class="row">
					...
					<div class="col-sm-6 col-md-7 col-xs-12 col-lg-8">
						<div class="contactForm">
							...
							<form action="tourist_write.action" method="post" role="form"
								...
								<div class="">
									<select class="select" name="citName">
										...
										<input type="text" class="addr" name="touAddress" placeholder="나머지 주소">
									</select>
								...
								<div class="form-group">
									<textarea class="form-control" placeholder="관광지 소개글"
										name="touContent"></textarea>
								</div>
