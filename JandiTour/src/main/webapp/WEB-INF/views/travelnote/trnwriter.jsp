      ...
      <div class="col-xs-12 ">
        <div class="recentActivityContent bg-ash">
          ...
          <div class="table-responsive" data-pattern="priority-columns">
            <form id="write_form" action="travelnote_writer.action" 
              ...
              <table class="table listingsTable" >
                ...
                <tr>
                  ...
                  <th height="22"><div align="center"></div></th>
                  <th><input type="text" name="trnTitle" style="width:200px" /></th>
                  <th>
                  	<input type="hidden" name="trnWriter" value="${ loginuser.memNo }">
                  	${ loginuser.memId } (${ loginuser.memNo })
                  </th>
                </tr>
                <tr>
                ...
                <tr>
                  <th height="18"><input type="text" name="trnArea" style="width:95px" /></th>
                  <th><input type="date" name="trnSt" style="width:145px" /></th>
                  <th><input type="date" name="trnEnd" style="width:145px" /></th>
                </tr>
                <tr>
            ...
            <a id="write" href="#">글쓰기</a> &nbsp;&nbsp; <a href="/janditour/travelnote_list.action">목록보기</a> </div>
        </div>
      </div>
    </div>
  </div>
